  ...
  return (
    <CreateReactionContext.Provider value={{ creatingReaction, setCreatingReaction, accordion, setAccordion }}>
      <View style={{ flex: 1, backgroundColor: baseBackgroundColor, padding: 10 }}>
        <Text style={{ fontSize: 23, fontWeight: 'bold', marginBottom: 5, color: 'white' }}>Heads up</Text>
        <Text style={{ color: 'white', marginBottom: 10 }}>
          On each library, we don't use traditional ❤️/👍 button to like each content. Instead, we use the original like
          buttons which are generated by the library creator(you). You can create multiple buttons (up to 3) and these
          are only applied to your library.
        </Text>
        <Icon />
        <ShortComment />
        <Color />
