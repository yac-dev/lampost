    ...
    <View style={{ backgroundColor: screenSectionBackgroundColor, padding: 7, borderRadius: 5, marginBottom: 10 }}>
      ...
      {accordion.description ? (
        <View style={{ marginTop: 10 }}>
          ...
          >
            <Text style={{ fontSize: 13, color: baseTextColor }}>Please write a description about this library.</Text>
            <Text style={{ color: formData.description.length <= 300 ? baseTextColor : 'red' }}>
