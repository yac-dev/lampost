...
const Container = (props) => {
  ...
  //     });
  //   }
  // }, [props.selectedBadges]); // これ完全に盲点だったわ。こんな罠があったとは。。。[]だと、first renderの時点のselectedItem[]でcallbackを登録しちゃっているんだわ。これ完全に盲点だった。
  ...
  if (props.badges.length) {
    ...
    return <Text>Now loading...okwjiofjoiwrjgiojrijijpgjopjopjqwopjopqjopw</Text>;
  }
};
